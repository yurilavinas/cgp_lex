...
class ModelBuilder:
    ...
    def compile(self, generations, _lambda, callbacks=None, dataset_inputs=None, select_on=None):
        ...
        strategy = OnePlusLambda(
            _lambda, factory, instance_method, mutation_method, fitness, select_on = select_on, # changed
        )
        model = ModelCGP(generations, strategy, parser, select_on)
        if callbacks:
