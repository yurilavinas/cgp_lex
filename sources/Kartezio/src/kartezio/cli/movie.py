...
def main():
    ...
    last_fitness = 0
    idx_to_frame = list(range(1, 11)) + list(range(10, 101, 5)) + list(range(100, 501, 10)) + list(range(500, 20001, 500)) #+ list(range(1000, 20001, 1000))
    ...
    for i in idx_to_frame:
        ...
        ax1.set_title("Parent AP Fitness over Generations", fontsize=7)
        ax1.set_xlim([0, i])
        ax1.set_ylim([0, 1])
