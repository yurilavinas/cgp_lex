...
cgp[nrow(cgp)+1,] <- cgp[nrow(cgp),]
cgp[nrow(cgp),]$generation <- 5000
cgp.lexicase[nrow(cgp.lexicase)+1,] <- cgp.lexicase[nrow(cgp.lexicase),]
cgp.lexicase[nrow(cgp.lexicase),]$generation <- 5000
alternating[nrow(alternating)+1,] <- alternating[nrow(alternating),]
alternating[nrow(alternating),]$generation <- 5000
# results = rbind(cgp, cgp.lexicase, alternating)
